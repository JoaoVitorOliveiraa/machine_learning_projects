...
show_data_head(10, dados_treinamento)

print("\n\n\t-----Descrição dos dados do conjunto de treinamento-----\n")
show_data_info(dados_treinamento)

print("\n\n\t-----Categorias das features e do alvo, com suas respectivas quantidades-----\n")
show_data_value_counts(dados_treinamento)

print("\n\n\t-----Resumo dos atributos numéricos-----\n")
show_data_description(dados_treinamento)

print("\n\n\t-----Features disponíveis-----\n")
return_data_columns(dados_treinamento)

print("\n\n-----Tipos das features-----\n")
show_data_columns_types(dados_treinamento)

print("\n\n\t-----Melhor exibição das classes das features-----\n")
show_colums_classes(dados_treinamento)
...
for feature in features_incompletas:
    ...
    # Substituindo os espaços ' ' por "classe_invalida".
        ...
        replace_class_value(dados_treinamento, features_siglas_estados_brasileiros, ' ', 'classe_invalida')
        replace_class_value(dados_teste, features_siglas_estados_brasileiros, ' ', 'classe_invalida')
...
calculate_classes_target_rate(dados_treinamento, features_categoricas)
...
dados_treinamento = apply_one_hot_encoder(dados_treinamento, features_categoricas, 'training', 'inadimplente')
